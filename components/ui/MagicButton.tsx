// Add Tailwind button to the website to show the work of other websites
import React from "react";

// Add classes to make the button responsive
const MagicButton = ({title, icon, position, handleClick, otherClasses}: {
    title: string; icon:React.ReactNode, position: string; handleClick?: () => void; otherClasses?: string;
}) => {
  return (
    // Add properties to the button and make it responsive on different size devices
